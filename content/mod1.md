...
{{< mod1_firmware title="Rose Oscillator" hex="MOD1_oseosc" buttonText="Flash Rose Oscillator" image="rose" >}}
...
**Controls:**
- **POT1**: Harmonics morphing (rose shape)
- **POT2**: Harmonic ratio (k parameter)
- **POT3**: Coarse frequency/tuning
- **F1 Input**: CV Input / V/Oct pitch CV
- **F2 Output**: X - Left component of complex signal
- **F3 Output**: Y - Right component of complex signal
 - **F4 Input**: Trigger input (CV options)
- **Button**: change modes / change CV mapping
{{< /mod1_firmware >}}
